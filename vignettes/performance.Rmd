...
The idea of the scale based performance measure is to measure where the Clarke-Wright solution is compared to both, the optimal solution, and the trivial solution[^1]. Let $c$ be the cost of the Clarke-Wright solution, and $o$ the optimal solution, and $t$ the cost of the trivial solution. The measure $\xi$ is defined by $$\xi := 1 - \frac{c - o}{t - o}\,.$$ The measure can move between zero and 1. It is zero if the Clarke-Wright solution is the trivial solution, and it is 1 if the Clarke-Wright solution is the optimal solution.
