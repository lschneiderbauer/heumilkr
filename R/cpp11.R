...
r_cpp_clarke_wright <- function(demand, distances, n_res, capacities, restr_sites, restr_vehicles) {
  .Call(`_heumilkr_r_cpp_clarke_wright`, demand, distances, n_res, capacities, restr_sites, restr_vehicles)
}
